app.controller("BillingCtrl", function ($scope, $http, blockUI) {
    ...
    function clear() {
        $scope.entity = { BillingId: 0, IsActive: true };
        $("#txtFocus").focus();
    };
    ...
    function submitRequest(trnType) {
        ...
        $http.post('/Billing/Post', params).success(function (data) {
    ...
    $scope.post = function () {
        //var where = "BillingName = '" + $scope.entity.BillingName + "'";
        //if ($scope.entity.BillingId > 0)
        //    where += " AND BillingId <> " + $scope.entity.BillingId;
        ...
        $http({
            ...
            alertify.log("Generate Bill Successfully", 'success', '5000');
